  ...
  <div class="container">
    <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
      <div class="section-heading">
        <h2 class="section__title text-white"><?php echo $breadCategory['category_name']; ?> Category</h2>
      </div>
      <ul class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
        <li><a href="index.html">Home</a></li>
        <li>Blog</li>
        <li><?php echo $breadCategory['category_name']; ?></li>
      </ul>
                ...
                <div class="card card-item">
                  <div class="card-image">
                    <a href="/blog/details/<?php echo $blogPost->getPostSlug(); ?>" class="d-block">
                      <img class="card-img-top lazy" src="/<?php echo $blogPost->getPostImage(); ?>" data-src="images/img8.jpg" alt="Card image cap">
                    </a>
                  ...
                  <div class="card-body">
                    <h5 class="card-title"><a href="/blog/details/<?php echo $blogPost->getPostSlug(); ?>"><?php echo $blogPost->getPostTitle(); ?></a></h5>
              ...
              <ul class="generic-list-item">
                <?php if (!empty($blogCategories)): ?>
                  <?php foreach ($blogCategories as $blogCategory): ?>
                    <li><a href="<?php echo $blogCategory->getId(); ?>"><?php echo $blogCategory->getCategoryName(); ?></a></li>
                  <?php endforeach; ?>
                <?php endif; ?>
              </ul>
          ...
          <div class="card card-item">
            <div class="card-body">
              ...
              <?php if (!empty($posts)): ?>
                <?php foreach ($posts as $post): ?>
                  <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                    <a href="/blog/details/<?php echo $post->getPostSlug(); ?>" class="media-img">
                      <img class="mr-3" src="/<?php echo $post->getPostImage(); ?>" alt="Related course image">
                    </a>
                    <div class="media-body">
                      <h5 class="fs-15"><a href="/blog/details/<?php echo $post->getPostSlug(); ?>"><?php echo $post->getPostTitle(); ?></a></h5>
              ...
              <div class="view-all-course-btn-box">
                <a href="/blog/posts/all" class="btn theme-btn w-100">View All Posts <i class="la la-arrow-right icon ml-1"></i></a>
              </div>
            </div>
          </div><!-- end card -->
        </div><!-- end sidebar -->

    ...
    <div class="container">
        <div class="breadcrumb-content">
            <div class="section-heading pb-3">
                <h2 class="section__title"> <?php echo $blogPost->getPostTitle(); ?></h2>
            </div>
            <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="/">Home</a></li>
                <li><a href="">Blog</a></li>
                <li><?php echo $blogPost->getPostTitle(); ?></li>
            </ul>
            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                <li class="d-flex align-items-center">By<a href="#">Admin</a></li>
                <li class="d-flex align-items-center"> <?php echo $blogPost->getCreatedAt(); ?> </li>
        ...
        <div class="row">
            <div class="col-lg-8 mb-5">
                <div class="card card-item">
                    <div class="card-body">
                        <p class="card-text pb-3"> <?php echo $blogPost->getDescription(); ?> </p>
                            ...
                            <ul class="generic-list-item generic-list-item-boxed d-flex flex-wrap fs-15">
                                <?php if (!empty($all_tags)): ?>
                                    <?php foreach ($all_tags as $tag): ?>
                                        <li class="mr-2"><a href="#"><?php echo $tag; ?></a></li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                            ...
                            <ul class="generic-list-item">
                                <?php if (!empty($blogCategories)): ?>
                                    <?php foreach ($blogCategories as $blogCategory): ?>
                                        <li><a href="/blog/category/list/<?php echo $blogCategory->getId(); ?>"><?php echo $blogCategory->getCategoryName(); ?></a></li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                        </div>
                                ...
                                <?php foreach ($posts as $post): ?>
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="/blog/details/<?php echo $post->getPostSlug(); ?>" class="media-img">
                                            <img class="mr-3" src="/<?php echo $post->getPostImage(); ?>" alt="Related Blogs Image">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="fs-15"><a href="/blog/details/<?php echo $post->getPostSlug(); ?>"></a><?php echo $post->getPostTitle(); ?></h5>

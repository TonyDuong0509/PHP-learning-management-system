        ...
        <div class="container">
            <div class="hero-content">
                <div class="section-heading">
                    <h2 class="section__title text-white fs-55 lh-60 pb-3 cd-headline zoom">
                        Find
                    ...
                    <p class="section__desc text-white pb-4">Choose from over 200,000 online video courses with new additions
                        <br>published by our instructor every month
                    </p>
                </div><!-- end section-heading -->
                <form method="post" class="w-50 pt-2">
                    <div class="form-group mb-0">
                        <input class="form-control form--control pl-3" type="text" name="search" placeholder="What do you want to learn?">
                ...
                <div class="row">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-icon-box d-flex align-items-center py-4">
                            ...
                            <div>
                                <h4 class="fs-20 font-weight-bold text-white">200,000 Online courses</h4>
                                <p class="text-white">Explore a variety of fresh topics</p>
                            </div>
                        </div><!-- info-icon-box -->
                    </div><!-- col-lg-4 -->
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-icon-box d-flex align-items-center py-4">
                            ...
                            <div>
                                <h4 class="fs-20 font-weight-bold text-white">Expert instruction</h4>
                                <p class="text-white">Find the right instructor for you</p>
                            </div>
                        </div><!-- info-icon-box -->
                    </div><!-- col-lg-4 -->
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-icon-box d-flex align-items-center py-4">
                            ...
                            <div>
                                <h4 class="fs-20 font-weight-bold text-white">Lifetime free access</h4>

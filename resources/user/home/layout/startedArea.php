<section class="get-started-area section--padding position-relative bg-gray overflow-hidden">
    ...
    <div class="container">
        <div class="section-heading text-center">
            <h2 class="section__title">Aduca's Guides</h2>
        ...
        <div class="row pt-50px">
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2 fs-18">Learn The Essential Skills</h5>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2 fs-18">Earn Certificates And Degrees</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        <svg width="70" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fill-rule="evenodd">
                                <g fill-rule="nonzero">
                                    <path d="m58 41c0 5.52-.9 10-2 10-6.7112284-1.0725403-13.4859779-1.7005743-20.28-1.88l-2.48-1.18c1.3819409-2.454038.8656032-5.5395726-1.24-7.41-.03-3.32 1.52-6.16.89-7.57 7.7404735-.0961258 15.4638975-.7511631 23.11-1.96 1.1 0 2 4.48 2 10z" fill="#f8e8ab" />
                                    <path d="m15 17.06-14.33-5.12c-.39548448-.1435417-.65882556-.5192718-.65882556-.94s.26334108-.7964583.65882556-.94l27.98-10c.2264785-.07998655.4735215-.07998655.7 0l27.98 10c.3954845.1435417.6588256.5192718.6588256.94s-.2633411.7964583-.6588256.94l-6.4 2.29-2.77.99-5.16 1.84z" fill="#393f4b" />
                                    <g fill="#f8e8ab">
                                        <path d="m2.14 50.97-.14.03c.04833698.0007373.09620934-.0095211.14-.03z" />
                                        <path d="m2.12 31.02c-.04032984-.004509-.08038777-.0111853-.12-.02.04066495.0017575.08096316.0084738.12.02z" />
                                        <path d="m2.13 31.02c7.19767563 1.1342429 14.4648019 1.7724135 21.75 1.91.66 1.46 3.12 4.53 3.12 8.07 0 .24 0 .47-.01.7-1.2350758 1.8750034-1.3199616 4.2826716-.22 6.24l-2.47 1.12c-7.4216238.1297297-14.82563445.7678913-22.16 1.91z" />
                                    </g>
                                    <path d="m24.99 41.7c.01-.23.01-.46.01-.7.1107196-2.7352573-.2685837-5.4682733-1.12-8.07 1.64.05 3.35.07 5.12.07 1.33 0 2.63-.01 3.89-.04.8073011 2.4394088 1.1796303 5.0017108 1.1 7.57z" fill="#ba3a23" />
                                    <path d="m30 51-2.66 6.37c-.147908.3777222-.5093466.6286703-.9149419.6352475-.4055954.0065773-.7749806-.2325197-.9350581-.6052475l-.73-1.68-1.68.72c-.3695259.1620183-.800349.0843318-1.0900103-.1965519s-.380564-.7091131-.2299897-1.0834481l2.54-6.1.47-1.12z" fill="#ba3a23" />
                                    <path d="m35.23 47.94.49 1.18 2.52 6.04c.1505743.374335.0596716.8025644-.2299897 1.0834481s-.7204844.3585702-1.0900103.1965519l-1.68-.72-.73 1.68c-.1600775.3727278-.5294627.6118248-.9350581.6052475-.4055953-.0065772-.7670339-.2575253-.9149419-.6352475l-2.66-6.37z" fill="#ba3a23" />
                                    <path d="m15 24v-11c0-1.66 6.27-3 14-3s14 1.34 14 3v11z" fill="#464f5e" />
                                    <path d="m50 15c-.5522847 0-1-.4477153-1-1v-6.56c0-.55228475.4477153-1 1-1s1 .44771525 1 1v6.56c0 .5522847-.4477153 1-1 1z" fill="#edc100" />
                                    <path d="m48 16v3c0 .5522847.4477153 1 1 1h2c.5522847 0 1-.4477153 1-1v-3c0-1.1045695-.8954305-2-2-2s-2 .8954305-2 2z" fill="#f1d24b" />
                                    <ellipse id="Oval" cx="29" cy="24" fill="#393f4b" rx="14" ry="3" />
                                    <path d="m4 41c0 5.28-.82 9.61-1.86 9.97-.04379066.0204789-.09166302.0307373-.14.03-1.1 0-2-4.48-2-10s.9-10 2-10c.01099251-.0013232.02199988.002346.03.01.02 0 .05.01.09.01h.01c1.04.35 1.87 4.68 1.87 9.98z" fill="#e2be50" />
                                    <path d="m36 45c0 3.3137085-2.6862915 6-6 6s-6-2.6862915-6-6 2.6862915-6 6-6c1.474849-.0086351 2.8990499.537487 3.99 1.53 1.2798799 1.1329139 2.0118537 2.7607361 2.01 4.47z" fill="#e04c34" />
                                </g>
                            </g>
                        </svg>
                        <h5 class="card-title pt-4 pb-2 fs-18">Get Ready for The Next Career</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        <svg width="70" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h5 class="card-title pt-4 pb-2 fs-18">Master at Different Areas</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->

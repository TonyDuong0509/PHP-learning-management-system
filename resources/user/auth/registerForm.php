            ...
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo $router->generate('user.register'); ?>" class="pt-4">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="name" required placeholder="...">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="username" required placeholder="Username">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email" required placeholder="Enter email address">
                            ...
                            <div class="btn-box">
                                ...
                                <p class="fs-14 pt-2">Already have an account? <a href="<?php echo $router->generate('login') ?>" class="text-color hover-underline">Log in</a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->

        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                ...
                <div class="media-body">
                    <h2 class="section__title fs-30"><?php echo $instructor->getName(); ?></h2>
                    <span class="d-block lh-18 pt-1 pb-2">Joined <?php echo $instructor->getCreatedAt(); ?> ago</span>
                    <p class="lh-18"><?php echo $instructor->getEmail(); ?></p>
                </div>
            </div><!-- end media -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-4 fs-35"><?php echo count($courses); ?></h4>
...
<section class="course-area section-padding">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between pb-3">
            ...
            <span class="ribbon ribbon-lg"><?php echo count($courses); ?></span>
        </div>
                        ...
                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                            <div class="card-image">
                                <a href="<?php echo $router->generate('course.details', ['id' => $course->getId(), 'slug' => $course->getSlug()]); ?>" class="d-block">
                                    <img style="width: 100%; height: 250px; object-fit: cover;" class="card-img-top" src="../<?php echo $course->getImage() ?? '/public/upload/no_image.png'; ?>" alt="Card image cap">
                                </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <?php endif; ?>
                                    <div class="mr-3">
                                        <a href="#" class="btn theme-btn flex-grow-1"><i class="la la-shopping-cart fs-16"></i></a>
                                    </div>

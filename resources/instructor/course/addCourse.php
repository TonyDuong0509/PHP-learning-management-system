        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="?c=course&a=storeCourse" method="POST" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <img id="showImage" src="" alt="Course" class="rounded-circle p-1 bg-primary" width="100">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="subcategory_id" class="form-select mb-3" aria-label="Default select example" required>
                            <option> </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="certificate" class="form-select mb-3" aria-label="Default select example" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="label" class="form-select mb-3" aria-label="Default select example" required>
                            <option selected="" disabled>Select Menu</option>

    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="<?php echo $router->generate('instructor.update.coupon'); ?>" method="POST" class="row g-3" enctype="multipart/form-data">
                    <input type="hidden" name="coupon_id" value="<?php echo $coupon->getId(); ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" name="coupon_discount" type="number" value="<?php echo $coupon->getCouponDiscount(); ?>">
                    </div>
                        ...
                        <select name="course_id" class="form-select mb-3" aria-label="Default select example">
                            ...
                            <?php if ($courses): ?>
                                <?php foreach ($courses as $course): ?>
                                    <option value="<?php echo $course->getId(); ?>" <?php echo ($course->getId() == $coupon->getCourseId()) ? 'selected' : '' ?>>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" name="coupon_validity" type="date" min="<?php echo date('Y-m-d'); ?>" value="<?php echo $coupon->getCouponValidity(); ?>">
                    </div>
                    <div class="col-md-12">

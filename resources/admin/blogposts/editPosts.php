    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="<?php echo $router->generate('blog.posts.update'); ?>" method="POST" class="row g-3" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $blogPost->getId(); ?>">
                    <input type="hidden" name="old_image" value="<?php echo $blogPost->getPostImage(); ?>">
                            ...
                            <?php if (!empty($blogCategories)): ?>
                                <?php foreach ($blogCategories as $blogCategory): ?>
                                    <option value="<?php echo $blogCategory->getId(); ?>"
                                        <?php echo ($blogCategory->getId() == $blogPost->getBlogCategoryId()) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="post_title" class="form-control" id="input1" value="<?php echo $blogPost->getPostTitle(); ?>">
                    </div>

                    <div class="form-group col-md-12">
                        <label for="input1" class="form-label">Post Description</label>
                        <textarea name="description" class="form-control" id="myeditorinstance"><?php echo $blogPost->getDescription(); ?></textarea>
                    </div>

                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label">Post Tags</label>
                        <input type="text" name="post_tags" class="form-control" data-role="tagsinput" value="<?php echo $blogPost->getPostTags(); ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        <img id="showImage" src="/<?php echo $blogPost->getPostImage(); ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="120">

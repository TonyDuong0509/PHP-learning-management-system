                                ...
                                <div class="p-4">
                                    ...
                                    <div class="text-center mb-4">
                                        ...
                                        <p class="mb-0 mt-2 text-decoration-underline">
                                            Don't have account ? <a href="/instructor/register/form">click here</a> to register
                                        </p>
                                    </div>
                                    <div class="form-body">
                                        <form method="POST" action="<?php echo $router->generate('instructor.login'); ?>" class="row g-3">
                                            <div class="col-12">
